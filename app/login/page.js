    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{background:'var(--cream)'}}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mt-4 mb-1" style={{color:'var(--charcoal)'}}>Welcome back</h1>
          <p style={{color:'var(--muted)'}}>Log in to manage your events.</p>
        </div>
        ...
        <p className="text-center mt-4 text-sm" style={{color:'var(--muted)'}}>
          ...
          <Link href="/signup" className="font-semibold" style={{color:'var(--gold)'}}>Sign up free</Link>
        </p>
      </div>
    </div>
  )
